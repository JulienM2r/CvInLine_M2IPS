 ...
 */
final class Version20191208105847 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cv CHANGE niv_exp_id niv_exp_id INT DEFAULT NULL, CHANGE bloc_contact_id bloc_contact_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE titre titre VARCHAR(255) DEFAULT \'Titre\' NOT NULL, CHANGE photo_avatar photo_avatar VARCHAR(255) DEFAULT \'Anonyme.jpg\' NOT NULL, CHANGE age age INT DEFAULT NULL, CHANGE texte_photo texte_photo VARCHAR(255) DEFAULT \'La rédaction d\'\'un cv nous cause des migraines car dans ce domaine on nous fait marcher sur la tête. Alain Leblay, Consultant RH.\'');
        $this->addSql('ALTER TABLE experiences DROP poste, CHANGE date_fin date_fin VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cv CHANGE niv_exp_id niv_exp_id INT DEFAULT NULL, CHANGE bloc_contact_id bloc_contact_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE titre titre VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'\'\'Titre\'\'\' NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE photo_avatar photo_avatar VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'\'\'Anonyme.jpg\'\'\' NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE texte_photo texte_photo VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'\'\'La rédaction d\'\'\'\'un cv nous cause des migraines car dans ce domaine on nous fait marcher sur la tête. Alain Leblay, Consultant RH.\'\'\' COLLATE `utf8mb4_unicode_ci`, CHANGE age age INT DEFAULT NULL');
        $this->addSql('ALTER TABLE experiences ADD poste VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE date_fin date_fin VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
