 ...
 */
final class Version20191204142316 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cv ADD bloc_contact_id INT DEFAULT NULL, CHANGE photo_avatar photo_avatar VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE cv ADD CONSTRAINT FK_B66FFE922613CDC FOREIGN KEY (bloc_contact_id) REFERENCES bloc_contact (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_B66FFE922613CDC ON cv (bloc_contact_id)');
        ...
        $this->addSql('ALTER TABLE reseaux_sociaux ADD cv_id INT NOT NULL, CHANGE logo logo VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cv DROP FOREIGN KEY FK_B66FFE922613CDC');
        $this->addSql('DROP INDEX UNIQ_B66FFE922613CDC ON cv');
        $this->addSql('ALTER TABLE cv DROP bloc_contact_id, CHANGE photo_avatar photo_avatar VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE experiences CHANGE date_fin date_fin DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE formation CHANGE date_fin date_fin DATETIME DEFAULT \'NULL\'');
        ...
        $this->addSql('ALTER TABLE reseaux_sociaux DROP cv_id, CHANGE logo logo VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
