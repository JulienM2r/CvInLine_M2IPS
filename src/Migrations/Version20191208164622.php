 ...
 */
final class Version20191208164622 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cv_reseaux_sociaux (cv_id INT NOT NULL, reseaux_sociaux_id INT NOT NULL, INDEX IDX_41541D75CFE419E2 (cv_id), INDEX IDX_41541D75CF0DF136 (reseaux_sociaux_id), PRIMARY KEY(cv_id, reseaux_sociaux_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE cv_reseaux_sociaux ADD CONSTRAINT FK_41541D75CFE419E2 FOREIGN KEY (cv_id) REFERENCES cv (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE cv_reseaux_sociaux ADD CONSTRAINT FK_41541D75CF0DF136 FOREIGN KEY (reseaux_sociaux_id) REFERENCES reseaux_sociaux (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE cv DROP res_soc_id, CHANGE niv_exp_id niv_exp_id INT DEFAULT NULL, CHANGE bloc_contact_id bloc_contact_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE titre titre VARCHAR(255) DEFAULT \'Titre\' NOT NULL, CHANGE photo_avatar photo_avatar VARCHAR(255) DEFAULT \'Anonyme.jpg\' NOT NULL, CHANGE age age INT DEFAULT NULL, CHANGE texte_photo texte_photo VARCHAR(255) DEFAULT \'La rédaction d\'\'un cv nous cause des migraines car dans ce domaine on nous fait marcher sur la tête. Alain Leblay, Consultant RH.\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE cv_reseaux_sociaux');
